...
namespace Genrev.Web.App.Analysis.Models
{
    ...
    public class ActualVsForecastVM
    {

        public List<CommonListItems.FiscalYear> FiscalYearList { get; set; } = CommonListItems.DataService.GetFiscalYearList();
        ...
        public CommonListItems.FiscalYear DefaultFiscalYear { get; set; }
